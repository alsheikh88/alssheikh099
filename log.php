...
if(isset($_POST['submit'])){
   ...
   $select = mysqli_query($conn, "SELECT * FROM ahmed1.ali WHERE email = '$email' AND password = '$pass'") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>هل تملك حساب بالفعل؟ <a href="ahmed.php"> حساب جديد</a></p>
   </form>
